...
import alarmtone from '@salesforce/resourceUrl/alarmtone';
import alarmclock from '@salesforce/resourceUrl/alarmclock';
import alarmclocksticker from '@salesforce/resourceUrl/alarmclocksticker';
export default class AlarmClockApp extends LightningElement {
      // Assiging the static resource to the variables 
  
      clockImage=alarmclocksticker
      ringtone= new Audio(alarmtone)
